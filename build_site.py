...
@media(max-width:720px){{.header-inner{{padding:34px 0 26px}}.toolbar{{align-items:stretch;flex-direction:column}}.grid{{grid-template-columns:1fr}}.card{{min-height:0}}}}
</style>
</head>
<body>
